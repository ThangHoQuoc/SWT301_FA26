...
class CalculatorTest {
    ...
    void divide_ByZero_ThrowsIllegalArgumentException() {
        ...
        // Act & Assert
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> calculator.divide(a, b));
    ...
    void multiply_VariousInputs_ReturnsProduct(int a, int b, int expected) {     // Arrange: a, b, expected do JUnit inject từ CSV
